              ...
              case CommandType.Npcs:
                ...
                switch (subdata.name) {
                  ...
                  case NpcCommands.Mold:
                    ...
                    const characters = await psql(characterData.list(channel.id));
          ...
          case InteractionType.APPLICATION_COMMAND:
            ...
            switch (name.toLowerCase()) {
              ...
              case CommandType.Npcs:
                ...
                switch (subdata.name) {
                  case NpcCommands.AutoGenerate:
                    psql(generateCharacters(channel.id))
                  ...
                  case NpcCommands.Create:
                    psql(characterData.create(subdata.options[0]?.value, channel.id, {
                  ...
                  case NpcCommands.List:
                    psql(characterData.list(channel.id))
                      .then((c) =>
                        CreateFollowupMessage(
                          token,
                          process.env.APP_ID!,
                  ...
                  case NpcCommands.Mold:
                    ...
                    psql(characterData.appendState(id, attribute, value))
                      .then(() =>
                        CreateFollowupMessage(
                          process.env.APP_ID!,
                          token,
              ...
              case CommandType.CreateDirective:
                psql(directiveData.create(channel.id, data.options[0]?.value))
              ...
              case CommandType.Fork:
                ...
                CreateChannel(process.env.SERVER_ID!, forkName, description).then(async (chan) => {
                  await psql(timelineData.create(chan.id, channel.id));
